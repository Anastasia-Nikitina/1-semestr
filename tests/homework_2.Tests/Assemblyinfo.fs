...
[<assembly: AssemblyTitleAttribute("homework_2.Tests")>]
[<assembly: AssemblyProductAttribute("homework_2")>]
...
module internal AssemblyVersionInformation =
    let [<Literal>] AssemblyTitle = "homework_2.Tests"
    let [<Literal>] AssemblyProduct = "homework_2"
